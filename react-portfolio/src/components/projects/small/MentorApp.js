   ...
   return(
      ...
      <div className='over-page'>
         ...
         <div className='one-img-hero-wrap'>
            <img src={'/assets/home/mentor.png'} alt="LionPlanner final design"/>
         </div>
         <div className='content-wrap'>
            <section id='tldr'>
               ...
               <br/><br/>I used this week-long project as an opportunity to improve my process and specicially to emphasize user research.</h6>
            ...
            <section id='case-study'>
               ...
               <div className="img-wrap">
                  <img src={'/assets/mentor-app/initial-thoughts.jpg'} alt="LionPlanner Still Needed" className='img-shadow'/>
               ...
               <div className="img-wrap">
                  <img src={'/assets/mentor-app/upper-responses.jpg'} alt="LionPlanner Still Needed" className='img-shadow'/>
               </div>
               <div className="img-wrap">
                  <img src={'/assets/mentor-app/under-responses.jpg'} alt="LionPlanner Still Needed" className='img-shadow'/>
               </div>
               ...
               <div className="img-wrap">
                  <img src={'/assets/mentor-app/user-specs.jpg'} alt="LionPlanner Still Needed" className='img-shadow'/>
               </div>
               ...
               <div className="img-wrap">
                  <img src={'/assets/mentor-app/feature-list.jpg'} alt="LionPlanner Still Needed" className='img-shadow'/>
               </div>
               ...
               <div className="img-wrap">
                  <img src={'/assets/mentor-app/user-journey-mentees.jpg'} alt="LionPlanner Still Needed" className='img-shadow'/>
               ...
               <div className="img-wrap">
                  <img src={'/assets/mentor-app/user-journey-mentors.jpg'} alt="LionPlanner Still Needed" className='img-shadow'/>
               </div>
               ...
               <div className="img-wrap">    
                  <img src={'/assets/mentor-app/mentee-sketches.jpg'} alt="LionPlanner Still Needed" className='img-shadow'/>
               </div>
               <div className="img-wrap">    
                  <img src={'/assets/mentor-app/mentor-sketches.jpg'} alt="LionPlanner Still Needed" className='img-shadow'/>
               </div>
               ...
               <div className="img-wrap">    
                  <img src={'/assets/mentor-app/lowfis.png'} alt="LionPlanner Still Needed" className='img-shadow'/>
               </div>
               ...
               <div className="img-wrap">    
                  <img src={'/assets/mentor-app/visual-design.png'} alt="LionPlanner Still Needed" className='img-shadow'/>
               </div>
               ...
               <div className="img-wrap">    
                  <img src={'/assets/mentor-app/browse.png'} alt="LionPlanner Still Needed"/>
               </div>
               ...
               <div className="img-wrap">    
                  <img src={'/assets/mentor-app/messages.png'} alt="LionPlanner Still Needed"/>
               </div>
               ...
               <div className="img-wrap">    
                  <img src={'/assets/mentor-app/quick-questions.png'} alt="LionPlanner Still Needed"/>
               </div>
               ...
               <div className="img-wrap">    
                  <img src={'/assets/mentor-app/recommend.png'} alt="LionPlanner Still Needed"/>
               </div>
